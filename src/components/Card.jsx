    ...
    <div className="border-2 border-yellow-200 rounded-3xl shadow-lg inline-block bg-white mb-4 ">
      <div className="px-3">
        <img
          src={imageSrc}
          alt={title}
          className="w-80 h-72 rounded-3xl shadow-md"
        />
      </div>

      <div className="p-2">
        <h2 className="font-nunito font-bold text-xl sm:text-2xl text-gray-900 mb-3">
          {title}
        </h2>
        <p className=" break-words w-80 h-24 font-lora text-gray-900 text-sm sm:text-lg overflow-auto">
          {description}
        </p>
      </div>
      ...
      <div className=" p-3 sm:p-6 text-center">
        <button
          className={`${btnclr}  text-white font-nunito font-bold sm:text-lg text-sm px-4 py-2 rounded-lg hover:scale-110`}
        >
          {buttonText}
        </button>
      </div>
