      ...
      <div className="py-10 px-5 lg:py-20 flex flex-col justify-center items-center">
        <div className="header flex justify-center mb-12">
          <span className="font-nunito font-bold sm:text-4xl lg:text-5xl text-3xl text-gray-900">
            Our{" "}
            <span className="underline decoration-custom-yellow decoration-4 underline-offset-0">
              Partner
            </span>
          </span>
        </div>
        ...
        <div className="relative w-full">
            ...
            customLeftArrow={
              <div className="absolute top-1/2 -left-4  transform -translate-y-1/2 z-20 mx-4">
                <img
                  src={left}
                  alt="left arrow"
                  className="h-12 w-12 cursor-pointer rounded-full bg-gray-200"
                />
              </div>
            }
            customRightArrow={
          ...
          >
            {items.map((item) => (
              <div
                key={item.id}
                className="bg-gray-100 flex justify-center items-center rounded-lg px-2 py-4 sm:mx-14 mx-20 "
              >
